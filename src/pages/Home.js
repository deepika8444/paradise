...
import {Footer,Button,Navbar,Nav,Container,NavDropdown,Carousel} from 'react-bootstrap';
...
const Home = () => {
  ...
  <div className="hs-item set-bg" style = {{backgroundImage: "url(" + "utils/img/hero/hero-2.jpg" + ")",
  ...
  backgroundRepeat: 'no-repeat'}} ></div>
         ...
         {/* <div className="hs-item set-bg" data-setbg="../public/utils/img/room/room-1.jpg" ></div> */}
         {/* <div className="hs-item set-bg" style = {{backgroundImage: "url(" + "utils/img/hero/hero-2.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}} ></div> */}
  ...
  backgroundRepeat: 'no-repeat'}}></div> */}
          ...
          {/* <div className="hs-item set-bg"style = {{backgroundImage: "url(" + "utils/img/hero/hero-3.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  ...
  <Carousel.Item>
    <img
      ...
      src="utils/img/hero/hero-1.jpg"
      alt="First slide"
    />
    <Carousel.Caption>
      <h1 style = {{color:"white"}}>Sona A Luxury Hotel</h1>
      <p style = {{color:"white"}}>Here are the best hotel booking sites, including
                  recommendations for international travel and for finding
              ...
              <div className="about-pic">
                <div className="row">
                  <div className="col-sm-6">
                    <img src="utils/img/about/about-1.jpg" alt="" />
                  </div>
                  <div className="col-sm-6">
                    <img src="utils/img/about/about-2.jpg" alt="" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="hp-room-items">
            <div className="row">
              <div className="col-lg-3 col-md-6">
                ...
                <div
                  className="hp-room-item set-bg"
                  style = {{backgroundImage: "url(" + "utils/img/room/room-b1.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
                >
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div
                  className="hp-room-item set-bg"
                  style = {{backgroundImage: "url(" + "utils/img/room/room-b2.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
                > 
              ...
              <div className="col-lg-3 col-md-6">
                <div
                  className="hp-room-item set-bg"
                  style = {{backgroundImage: "url(" + "utils/img/room/room-b3.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
                >
              ...
              <div className="col-lg-3 col-md-6">
                <div
                  className="hp-room-item set-bg"
                  style = {{backgroundImage: "url(" + "utils/img/room/room-b4.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
                >
            ...
            <div className="col-lg-8 offset-lg-2">
              <div className="testimonial-slider owl-carousel">
                <div className="ts-item">
                  ...
                  <img src="../utils/img/testimonial-logo.png" alt="" />
                </div>
                <div className="ts-item">
                  <p>
                    After a construction project took longer than expected, my
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4">
              ...
              <div className="blog-item set-bg"  style = {{backgroundImage: "url(" + "utils/img/blog/blog-1.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
            ...
            <div className="col-lg-4">
              <div className="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-2.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                <div className="bi-text">
            ...
            <div className="col-lg-4">
              <div className="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-3.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                <div className="bi-text">
            ...
            <div className="col-lg-8">
              ...
              <div
                className="blog-item small-size set-bg"
                style = {{backgroundImage: "url(" + "utils/img/blog/blog-wide.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
              >
            ...
            <div className="col-lg-4">
              ...
              <div
                className="blog-item small-size set-bg"
                style = {{backgroundImage: "url(" + "utils/img/blog/blog-10.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}
              >
