...
const BlogDetails = () => {
    return (
        ...
        <section
          ...
          style = {{backgroundImage: "url(" + "utils/img/blog/blog-details/blog-details-hero.jpg" + ")",
  ...
  backgroundRepeat: 'no-repeat'}}
            ...
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                <div class="blog-details-text">
                  ...
                  <div class="bd-pic">
                    <div class="bp-item">
                      <img src="../utils/img/blog/blog-details/blog-details-1.jpg" alt="" />
                    </div>
                    <div class="bp-item">
                      <img src="../utils/img/blog/blog-details/blog-details-2.jpg" alt="" />
                    </div>
                    <div class="bp-item">
                      <img src="../utils/img/blog/blog-details/blog-details-3.jpg" alt="" />
                    </div>
                  </div>
                  ...
                  <div class="comment-option">
                    ...
                    <div class="single-comment-item first-comment">
                      <div class="sc-author">
                        <img
                          src="../utils/img/blog/blog-details/avatar/avatar-1.jpg"
                          alt=""
                        />
                      </div>
                      <div class="sc-text">
                    ...
                    <div class="single-comment-item reply-comment">
                      <div class="sc-author">
                        <img
                          src="../utils/img/blog/blog-details/avatar/avatar-2.jpg"
                          alt=""
                        />
                      </div>
                      <div class="sc-text">
                    ...
                    <div class="single-comment-item second-comment">
                      <div class="sc-author">
                        <img
                          src="../utils/img/blog/blog-details/avatar/avatar-3.jpg"
                          alt=""
                        />
                      </div>
                      <div class="sc-text">
        ...
        <section class="recommend-blog-section spad">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-1.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-md-4">
                ...
                style = {{backgroundImage: "url(" + "utils/img/blog/blog-2.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
