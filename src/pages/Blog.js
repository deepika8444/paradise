...
const Blog = () => {
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-md-6">
                ...
                style = {{backgroundImage: "url(" + "utils/img/blog/blog-1.jpg" + ")",
  ...
  backgroundRepeat: 'no-repeat'}}>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-2.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-3.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-4.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-5.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-6.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-7.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-8.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" style = {{backgroundImage: "url(" + "utils/img/blog/blog-9.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}>
                  <div class="bi-text">
